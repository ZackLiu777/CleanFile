...
- Privacy Policy：`https://zane-liao.github.io/privacy/`
- Terms of Use：`https://zane-liao.github.io/terms/`
...
2. 在 App Store Connect 的 App 隐私政策字段填写 Privacy Policy URL；在 App 描述或自定义许可协议字段中提供 Terms of Use URL，并确认两个网页无需登录即可公开访问且返回 HTTP 200。
